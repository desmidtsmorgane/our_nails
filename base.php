...
<html lang="fr">
    <head>
      <title>La base - Apprendre | Our Nails - Nail Art</title>
      <meta charset="UTF-8">
    ...
    <section id="base">
      ...
      <h3>Tu as besoin de</h3>
        ...
        <div id="etape_5">
          <h3>5. La french blanche</h3>
          <p>Avec le gel blanc, appliquer une couche sur le bout de l'ongle en partant de la gauche vers la droite tout en créant une courbe. Catalysez.</p>
          <div class="instruction">
          <ul>
          ...
          <div class="french_1">avec le gel blanc, partir de la gauche</div> <!-- end french_1 -->
          <div class="french_2">avec le gel blanc, continuer le trait vers la droite</div> <!-- end french_1 -->
          <div class="french_3">avec le gel blanc, remplir la forme</div> <!-- end french_1 -->
        </div> <!-- end etape_5 -->
