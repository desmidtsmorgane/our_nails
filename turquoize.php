...
<html lang="fr">
    <head>
      <title>Mix turquoize - Apprendre | Our Nails - Nail Art</title>
      <meta charset="UTF-8">
    ...
    <div id="container">
    <section id="turquoize">
      <h2>Mix turquoize</h2>
      <p>
        Cette pose consiste à réaliser un Nail Art composé de strass. On peut changer de couleur en fonction de l'ongle.
      </p>
      ...
      <h3>Tu as besoin de</h3>
        <ul class="materiels">
          ...
          <li>- <a href="produits.php" target="_blank">Gel turquoize</a></li>
          ...
          <li>- <a href="produits.php" target="_blank">Perles</a></li>
        ...
        <div id="etape_3">
          ...
          <div class="primer_2">mettre du primer en partant vers le bas</div> <!-- end primer_1 -->
        </div> <!-- end etape_3 -->

        <div id="etape_4">
          <h3>4. La base</h3>
          <p>Appliquez une fine couche de gel puis catalyser environ 2 à 3 minutes sous la lampe. Dégraissez avec le dissolvant.</p>
        ...
        <div id="etape_5">
          <h3>5. Le Nail Art</h3>
          <p>Avec le gel turquoize, réalisez deux triangles inversés, ensuite ajoutez-y les strass. Catalysez.</p>
          <div class="instruction">
          <ul>
          ...
          <ul class="left">
            <li><svg version="1.1" id="materiel_french" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="33.75px" height="26.25px" viewBox="0 0 33.75 26.25" enable-background="new 0 0 33.75 26.25" xml:space="preserve"> <path fill="#DB7197" stroke="#DB7197" stroke-width="0.3" stroke-miterlimit="10" d="M0.5,24.586c0,0,1.265-1.498,2.81-2.716 c1.545-1.218,5.877-5.053,6.087-5.229C9.608,16.466,25.216,2.527,25.216,2.527s0.55-0.503,0.901-0.152 c0.352,0.351,0.047,0.515-0.375,0.89C25.32,3.639,14.083,15.003,14.083,15.003s-3.515,3.017-3.89,3.251 c-0.375,0.234-6.229,4.553-6.229,4.553S2.233,24.024,0.5,24.586z"/> <path fill="#FFFFFF" stroke="#DB7197" stroke-width="0.3" stroke-miterlimit="10" d="M10.372,18.125c0,0-0.503-1.146-1.216-1.282 l-0.221,0.185c-1.218,0.924-4.334,3.826-5.625,4.843c0,0,0.772,0.38,0.655,0.937C3.965,22.807,9.998,18.359,10.372,18.125z"/> <path fill="#878787" d="M55.465-9.089c4.258,0,7.711,3.453,7.711,7.71c0,7.036-13.941,16.382-13.941,16.382 S35.293,5.995,35.293-1.379c0-5.3,3.453-7.71,7.709-7.71c2.564,0,4.828,1.258,6.232,3.184C50.637-7.831,52.9-9.089,55.465-9.089z" /></svg><p>Gel turquoize</p></li>
            <li>Pinceau fin</li>
            <li>Perles</li>
          </ul>
          </div> <!-- end instruction -->
          
          <div class="forme_1">avec le gel turquoize, formez un triangle inversé</div> <!-- end french_1 -->
          <div class="forme_2">avec le gel turquoize, formez un triangle inversé</div> <!-- end french_1 -->
          <div class="forme_3">avec le gel turquoize, ajoutez les strass</div> <!-- end french_1 -->
        </div> <!-- end etape_5 -->
    ...
    <div id="disqus_thread"></div>
        ...
        <?php
          ...
          {
          ?>
          <a href="creation_tutoriel" class="button">Créer mon tutoriel</a>
          <?php
          }
          else
          {
