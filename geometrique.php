...
<html lang="fr">
    <head>
      <title>Géométrique - Apprendre | Our Nails - Nail Art</title>
      <meta charset="UTF-8">
    ...
    <div id="container">
    <section id="geometrique">
      <h2>Géométrique</h2>
      <p>
        Cette pose consiste à réaliser une forme géométrique composée 
      ...
      <ul class="info">
        ...
        <li><span>Catégorie:</span> Nail Art</li>
      </ul>

      <div id="resultat">résultat de la pose</div> <!-- end resultat -->
      
      <h3>Tu as besoin de</h3>
        <ul class="materiels">
          <li>- <a href="produits.php" target="_blank">Gel monophasé</a></li>
          <li>- <a href="produits.php" target="_blank">Gel blanc</a></li>
          <li>- <a href="produits.php" target="_blank">Gel praline</a></li>
          <li>- <a href="produits.php" target="_blank">Gel nude</a></li>
        ...
        <div class="materiel">liste du matériel</div> <!-- end materiel -->

        <div id="etape_1">
          <h3>1. Les cuticules</h3>
          <p>Repoussez les cuticules, en partant du bas de l'ongle vers le haut tout en poussant délicatement.</p>
          <ul>
          ...
          <div class="cuticule_1">repousser les cuticules en partant du bas</div> <!-- end cuticule_1 -->
          <div class="cuticule_2">repousser les cuticules en allant vers le haut</div> <!-- end cuticule_2 -->
        </div> <!-- end etape_1 -->

        <div id="etape_2">
          <h3>2. Le ponçage</h3>
          <p>Poncez l’entièreté de l’ongle avec une lime ou un bloc. Pour le mouvement, c'est au choix, il faut juste veiller à bien poncer l'entièreté.</p>
          <ul>
            <li><svg version="1.1" id="temps_poncage" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="27px" height="27.333px" viewBox="0 0 27 27.333" enable-background="new 0 0 27 27.333" xml:space="preserve"> <path fill="#DB7197" d="M13.954,1.502c-6.742,0-12.208,5.466-12.208,12.208s5.466,12.208,12.208,12.208s12.208-5.466,12.208-12.208 S20.696,1.502,13.954,1.502z M13.954,24.292c-5.844,0-10.582-4.737-10.582-10.582c0-5.844,4.738-10.582,10.582-10.582 c5.845,0,10.583,4.738,10.583,10.582C24.537,19.555,19.799,24.292,13.954,24.292z"/> <line fill="none" stroke="#DB7197" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="13.954" y1="6.332" x2="13.954" y2="13.71"/> <line fill="none" stroke="#DB7197" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="13.954" y1="13.71" x2="17.128" y2="18.361"/></svg><p>5 min.</p></li>
          ...
          <div class="poncage_1">poncer de la droite</div> <!-- end poncage_1 -->
          <div class="poncage_2">poncer vers la gauche</div> <!-- end poncage_2 -->
        </div> <!-- end etape_2 -->

        <div id="etape_3">
          <h3>3. Le primer</h3>
          <p>Appliquez le primer sur l’entièreté de l’ongle pour que le gel adhère parfaitement.</p>
          <ul>
          ...
          <div class="primer_1">mettre du primer en partant du haut</div> <!-- end primer_1 -->
          <div class="primer_2">mettre du primer en partant vers le bas</div> <!-- end primer_2 -->
        </div> <!-- end etape_3 -->

        <div id="etape_4">
          <h3>4. La base</h3>
          <p>Appliquez une fine couche de gel puis catalysez environ 2 à 3 minutes sous la lampe. Dégraissez avec le dissolvant.</p>
          ...
          <div class="base">appliquer le gel de base</div> <!-- end base -->
          <div class="catalyser">catalyser dans le four</div> <!-- end catalyser -->
          <div class="degraisser">dégraisser avec le dissolvant</div> <!-- end degraisser -->
        </div> <!-- end etape_4 -->

        <div id="etape_5">
          <h3>5. Les formes géométrique</h3>
          <p>Avec le gel de couleur nude, réalisez une diagonale puis remplir la forme. Réalisez
            cette même étape avec le gel praline et blanc. Catalysez.</p>
          <div class="instruction">
          <ul>
          ...
          <div class="forme_1">avec le gel nude, remplir la forme</div> <!-- end forme_1 -->
          <div class="forme_2">avec le gel brun, remplir la forme</div> <!-- end forme_2 -->
          <div class="forme_3">avec le gel blanc, remplir la forme</div> <!-- end forme_3 -->
        </div> <!-- end etape_5 -->

        <div id="etape_6">
          <h3>6. La construction</h3>
          <p>Pour terminer, une couche de gel monophasé pour faire la construction. Catalysez puis dégraissez et ensuite appliquez une couche de vernis.</p>
          <div class="instruction">
          <ul>
          ...
          <div class="construction">appliquer le gel pour faire la construction</div> <!-- end construction -->
          <div class="catalyser_construction">catalyser dans le four</div> <!-- end catalyser_construction -->
          <div class="degraisser">dégraisser avec le dissolvant</div> <!-- end degraisser -->
          <div class="vernis">appliquer une couche de vernis</div> <!-- end vernis -->
        </div> <!-- end etape_6 -->

        <div id="etape_7">
          <h3>Le résultat</h3>
          <div class="resultat">résultat de la pose</div> <!-- end resultat -->
        </div> <!-- end etape_7 -->
    ...
    <div id="disqus_thread"></div>
        ...
        ?>
      </section> <!-- end section geometrique -->

    </div> <!-- end container -->

    <div id="tutoriel_suivant">
      <ul>
          <li>
            <img src="img/base/lilas.png" alt="tutoriel lilas" />
            <h3>Lilas</h3>
            <p>Uni couleur simple et agréable de couleur lilas.</p>
            <a href="lilas.php" class="button">Voir le tutoriel</a>
          </li>
      </ul>
    </div> <!-- end tutoriel suivant -->
